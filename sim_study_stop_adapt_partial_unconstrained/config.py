...
INFERENCE_DIR = "/rds/user/jbb50/hpc-work/SEIR_model/stop_adapt_partial_unconstrained"
...
PRIORS = {
    ...
    "beta": params.LogGaussianRWNonCentred(stats.expon(scale=1/50), model.num_betas, sample_log_scale=True),
